...
Celbridge is [Free and open source Software](https://en.wikipedia.org/wiki/Free_and_open_source_software)
...
Attribution 4.0 International ([CC BY 4.0](https://creativecommons.org/licenses/by/4.0/)) license, with attribution
to "the Celbridge community."

Logos and icons are generally under the same Creative Commons license.

For full details, look at the [LICENSE.txt](https://github.com/celbridge-org/celbridge/blob/main/LICENSE.txt)
...
- [the Github repo issues](https://github.com/celbridge-org/celbridge/issues)
- the Celbridge community [Discourse forum](https://celbridge.discourse.group/)
...
any [issues](https://github.com/celbridge-org/celbridge/issues) that you might experience.
...
- if you're not sure how/whether to contribute, talk to us at the Celbridge community [Discourse forum](https://celbridge.discourse.group/) :-)

## Who is working on Celbridge?

See the named contributions/credits on the [Celbridge Github repo](https://github.com/celbridge-org/celbridge).
