...
Welcome to the offical documentation pages for of `Celbridge <https://www.celbridge.org/>`_, the free and open source community-driven Python and data pipline workbench application.

This page gives a broad overview of the workbench application and of this documentation,
...
You can find help on the the Celbridge  community `Discourse forum <https://celbridge.discourse.group/>`_.
...
- **Getting Started**
    This :ref:`doc_getting_started_intro` section is the best place to start, to get to know Celbridge.
...
with attribution to "*the Celbridge community*"
