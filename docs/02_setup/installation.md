...
!!! note
    ...
    Celbridge currently runs on Windows only.

    A macOS version is planned, and Linux/WASM versions may be possible depending on demand.
...
You can find the current and past releases at the Celbridge project site:  [![Github Octocat logo](../images/github-mark.svg){ width="5%" }](https://github.com/celbridge-org/celbridge/)
