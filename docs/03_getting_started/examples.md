...
![Screenshot showing Python version and extensions in .celbridge configuration](images/examples.png)

You should now have a proejct with several examples, each in their own directories:
![Screenshot showing Celbridge project containing examples](images/new_examples_project.png)
